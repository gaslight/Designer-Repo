# -*- encoding: utf-8 -*-
# stub: github-pages 195 ruby lib
...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      ...
      s.add_runtime_dependency(%q<github-pages-health-check>.freeze, ["= 1.16.0"])
      ...
      s.add_runtime_dependency(%q<nokogiri>.freeze, ["< 2.0", ">= 1.8.5"])
      ...
      s.add_dependency(%q<github-pages-health-check>.freeze, ["= 1.16.0"])
      ...
      s.add_dependency(%q<nokogiri>.freeze, ["< 2.0", ">= 1.8.5"])
